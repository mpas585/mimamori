...
@section('title', '検知ログ - ' . $device->device_id)

@section('styles')
<style>
    .log-container { max-width: 900px; margin: 0 auto; padding: 24px 20px; }
    ...
    .log-back-btn:hover { background: var(--gray-200); }
    .log-page-title {
        font-size: 18px;
        font-weight: 700;
        color: var(--gray-800);
    ...
    .summary-label { font-size: 11px; color: var(--gray-500); margin-top: 2px; }
    ...
    .pagination-wrap span.disabled { color: var(--gray-300); border-color: var(--gray-200); }
    .log-summary { font-size: 12px; color: var(--gray-500); }
    ...
    @media (max-width: 600px) {
        .log-container { padding: 16px 12px; }
        .filter-bar { flex-direction: column; }
        .filter-input, .filter-select { width: 100%; }
        .log-details { gap: 10px; }
...
<div class="log-container">
    ...
    <div class="log-page-header">
        <a href="{{ $backUrl }}" class="log-back-btn">←</a>
        <h1 class="log-page-title">検知ログ</h1>
        <span class="log-device-id">{{ $device->device_id }}</span>
    </div>
