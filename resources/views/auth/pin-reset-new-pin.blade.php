...
<body>
    <div class="container">
        ...
        <div class="card">
            <h1 class="card-title">新しいPINを設定</h1>
            <p class="card-desc">新しい4桁のPINを入力してください</p>
            ...
            <form method="POST" action="/pin-reset/token/{{ $token }}">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="newPin" name="new_pin" class="form-input pin-input"
                           placeholder="••••" maxlength="4" inputmode="numeric" autocomplete="new-password" autofocus>
