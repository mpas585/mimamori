...
<div class="terms-card">
    ...
    <article class="article" id="article1">
        ...
        <div class="article-content">
            <p>本規約は、ウエダ・トレーディング株式会社（以下「当社」）が提供する「みまもりデバイス」（以下「本サービス」）の利用に関する条件を定めるものです。本サービスをご利用いただく方（以下「利用者」）は、本規約に同意したものとみなします。</p>
        </div>
    </article>
    ...
    <article class="article" id="article2">
        ...
        <div class="article-content">
            ...
            <ol>
                <li><strong>本デバイス</strong>：当社がレンタル提供する見守りセンサーデバイス「みまもりデバイス」</li>
    ...
    <article class="article" id="article4">
        ...
        <div class="article-content">
            <ol>
                ...
                <li><strong>オプション料金：</strong>SMS通知（月額300円/台）、AIコール通知（月額500円/台）を任意でご契約いただけます。オプション料金は今後改定される場合があります。</li>
