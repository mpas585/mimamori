...
<header class="header">
    <div class="header-inner" style="max-width:640px;">
        ...
        <h1 style="font-size:16px;font-weight:600;flex:1;">設定</h1>
...
<style>
    ...
    .toggle {
        ...
        background: var(--gray-300); border-radius: 15px;
    ...
    .premium-badge {
        ...
        color: var(--white); background: linear-gradient(135deg, #667eea, #764ba2);
    ...
    .test-notify-btn {
        ...
        font-family: inherit; background: var(--beige); color: var(--gray-700);
    ...
    .test-notify-btn .spinner {
        ...
        border: 2px solid var(--gray-300); border-top-color: var(--gray-600);
    ...
    .alert-option.selected .alert-radio::after {
        content: ''; width: 10px; height: 10px; background: var(--gray-800); border-radius: 50%;
    }
    ...
    .info-box {
        padding: 14px 16px; background: var(--blue-light); border-radius: var(--radius);
        font-size: 13px; color: var(--gray-700); line-height: 1.7; margin-top: 16px;
    }
    ...
    .feature-toggle {
        ...
        padding: 16px; background: var(--beige); border-radius: var(--radius); margin-bottom: 20px;
    }
    ...
    #diagramCanvas {
        display: block; margin: 0 auto; background: var(--white);
    ...
    .explanation-box {
        margin-top: 16px; padding: 14px 16px; background: var(--blue-light);
    ...
    .premium-promo-btn {
        ...
        color: #667eea; background: var(--white); border: none;
        border-radius: var(--radius); cursor: pointer; transition: all 0.2s; text-decoration: none;
    }
...
<div class="container">
    ...
    <section class="section">
        ...
        <div class="info-box">
            <strong>💡 アラート時間の目安</strong><br>
            早期発見が重要です。24時間以内であれば、万が一の場合も事故物件化を防げる可能性が高くなります。
        </div>
    </section>
