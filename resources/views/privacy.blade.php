...
@section('title', 'プライバシーポリシー - みまもりトーフ')
    ...
    <div class="legal-card">
        ...
        <article class="article">
            <div class="article-content">
                <p>ウエダ・トレーディング株式会社（以下「当社」）は、IoT見守りサービス「みまもりトーフ」（以下「本サービス」）の提供にあたり、利用者の個人情報を以下のとおり適切に取り扱います。</p>
            </div>
        </article>
        ...
        <article class="article">
            ...
            <div class="article-content">
                <ul>
                    ...
                    <li>AIコールの通話記録：判定処理後、速やかに削除します。</li>
